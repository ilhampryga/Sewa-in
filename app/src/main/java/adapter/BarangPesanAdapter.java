...
public class BarangPesanAdapter extends BaseAdapter {

    private Context context;
    private List<BarangPesan> listBarang;
    private String role;

    public BarangPesanAdapter(Context context, List<BarangPesan> listBarang, String role) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        BarangPesan barang = listBarang.get(position);

        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.activity_item_tab_dipesan, parent, false);
        }
